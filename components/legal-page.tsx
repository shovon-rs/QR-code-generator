  ...
  return (
    <>
      ...
      <main id="main-content" className="container mx-auto max-w-3xl flex-1 px-4 py-12">
        ...
        <article className="bg-card border-border space-y-4 rounded-xl border p-6 leading-relaxed shadow-sm sm:p-8 [&_h2]:mt-6 [&_h2]:text-lg [&_h2]:font-semibold [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-5">
